      ...
      <div className="relative mx-auto flex flex-col w-11/12 max-w-maxContent items-center text-white justify-between md:gap-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center my-16">
          <div className="w-[100%] md:w-[50%]">
            <div className="text-3xl sm:text-4xl text-center font-semibold mb-7">
              Master Skills,
              <HighlightText text={" One Step at a Time"} />
            </div>

            <div className="text-md sm:text-lg font-bold text-center text-richblack-300">
          ...
          <div className="w-[100%] md:w-[50%] flex justify-center items-center mt-16 md:mt-0">
            <img src={Home1} width={"80%"} alt="success" />
          </div>
        </div>
        ...
        <div className="flex flex-col-reverse md:flex-row justify-center items-center gap-10 sm:gap-20 mb-10">
          ...
          <div className="w-[100%] md:w-[50%] flex flex-col gap-6">
            ...
            <div className="w-[90%] text-lg md:text-xl font-bold text-blue-50s">
              Stay Consistent and Master New Skills Effectively
            </div>

            <div className="w-[90%] text-md md:text-lg font-bold text-richblack-300">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center mt-10 gap-10 sm:gap-20 mb-10">
          ...
          <div className="w-[100%] md:w-[50%] flex flex-col gap-6">
            ...
            <div className="w-[90%] text-lg sm:text-xl font-bold text-blue-50s">
              Monitor Your Progress and Showcase Your Achievements
            </div>

            <div className="w-[90%] text-md sm:text-lg font-bold text-richblack-300">
        ...
        {/* Section 4 */}
        <div className="flex flex-col-reverse md:flex-row justify-center items-center gap-10 md:gap-10">
          {/* left part */}
          <div className="w-[100%] md:w-[50%] flex justify-center items-center">
            <img
              src={Home4}
